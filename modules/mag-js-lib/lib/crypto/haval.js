...
var EncryptPwHaval = (function () {
    ...
    EncryptPwHaval.prototype.padBuffer = function () {
        ...
        // result[padding++] = 255 & ((bits >>> 8) | 0);
        // result[padding++] = 255 & ((bits >>> 16) | 0);
        // result[padding++] = 255 & ((bits >>> 24) | 0);
        // result[padding++] = 255 & ((bits >>> 32) | 0);
        // result[padding++] = 255 & ((bits >>> 40) | 0);
        // result[padding++] = 255 & ((bits >>> 48) | 0);
        // result[padding] = 255 & ((bits >>> 56) | 0);
        result[padding++] = 255 & (bits | 0);
        bits = bits >>> 8;
        result[padding++] = 255 & (bits | 0);
        bits = bits >>> 8;
